...
public class STablesTest {
    ...
    @Test
    public void getS0TableByte() throws CryptoException {
        for (int i = 0; i < 16; i++) {
            for (int j = 0; j < 16; j++) {
                assertEquals((byte)s0TableShort[i][j], STables.getS0TableByte(i, j));
            }
        }
    }

    @Test
    public void getS1TableByte() throws CryptoException {
        for (int i = 0; i < 16; i++) {
            for (int j = 0; j < 16; j++) {
                assertEquals((byte)s1TableShort[i][j], STables.getS1TableByte(i, j));
            }
        }
    }
}